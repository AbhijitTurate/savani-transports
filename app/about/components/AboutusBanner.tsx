    ...
    return (
        <div className={`flex flex-col-reverse md:flex-row ${reverse ? "md:flex-row-reverse" : ""
            ...
            <div className='flex flex-col flex-1'>
                <h1 className={`text-2xl ${reverse ? "md:text-[2.5rem]" : " md:text-7xl tracking-[-0.04em]"
                    }  ${!reverse ? 'line-height-86' : ''}font-semibold font-figtree`}>{title}</h1>
                <p className='text-lg mt-2 md:mt-6 font-figtree text-base text-primary-text-color-70 tracking-[0.04em]'>{description}</p>
            </div>
            <img
